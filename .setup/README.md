...
That said, the `TinyAgent` that we will be building throughout this book requires a very minimal set of dependencies. All we want to do is call an LLM and build up our Agent using that. Therefore, we decided that the **only** dependency is going to be `LiteLLM` which allows to easily access many local and cloud providers of LLMs. 

You can also use local LLMs with `LiteLLM`, such as:

* [`Ollama`](https://docs.litellm.ai/docs/providers/ollama)
* [`llama.cpp`](https://docs.litellm.ai/docs/providers/openai_compatible)
* [`LMStudio`](https://docs.litellm.ai/docs/providers/lm_studio)
